...
namespace HRTool.Controllers
{
    public class EmployeeController : ApiController
    {
        ...
        {
            new EmployeesByDate(new DateTime(2019, 6, 21), new List<int>(){91}),
            new EmployeesByDate(new DateTime(2019, 11, 1), new List<int>(){1,2}),
            new EmployeesByDate(new DateTime(2020, 2, 11), new List<int>(){3})
        };
